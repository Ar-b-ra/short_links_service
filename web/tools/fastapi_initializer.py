...
async def object_exists_exception_handler(request: Request, exc: Exception) -> PlainTextResponse:  # noqa
    """
...
async def no_permission_exception_handler(request: Request, exc: Exception) -> PlainTextResponse:  # noqa
    """
