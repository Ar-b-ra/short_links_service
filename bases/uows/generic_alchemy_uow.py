...
class AlchemySyncGenericUOW(base_uow.BaseSyncUOW, Generic[T, O, C, U]):
    ...
    def __init__(
        self,
        repository: base_alchemy_generic_repository.BaseAlchemyGenericSyncRepository[T, O, C, U],  # noqa
    ) -> None:
        """
...
class AlchemyAsyncGenericUOW(base_uow.BaseAsyncUOW, Generic[T, O, C, U]):
    ...
    def __init__(
        self,
        repository: base_alchemy_repository.BaseAlchemyAsyncRepository[O]
        | base_alchemy_generic_repository.BaseAlchemyGenericAsyncRepository[T, O, C, U],
    ) -> None:
...
class TestAlchemyAsyncUOW(AlchemyAsyncGenericUOW[T, O, C, U], Generic[T, O, C, U]):
    ...
    def __init__(
        self,
        repository: base_alchemy_generic_repository.BaseAlchemyGenericAsyncRepository[T, O, C, U],  # noqa
    ) -> None:
        """
        Инициализировать переменные
        :param repository: репозиторий
